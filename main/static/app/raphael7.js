...
Raphael = (function () {
    ...
    if (R.svg) {
        ...
        Paper[proto].xmlns = "http://www.w3.org/1999/xhtml";
        round = function (num) {
        ...
        var addGradientFill = function (o, gradient, SVG) {
            ...
            for (var i = 0, ii = dots[length]; i < ii; i++) {
                ...
                $(stop, {
                    ...
                    "stop-color": dots[i].color || "#fff","stop-opacity": dots[i].opacity || "1"
                });
                el[appendChild](stop);
            }
            $(o, {
        ...
        var theFrame = function (svg, x, y, w, h, u, s) {
            x = round(x);
            y = round(y);
            var scl = "";
            if (s!= null) scl = "\ scale(" + s + ")"
            var el = $("foreignObject");
            var res = new Element(el, svg);
            var trf = "translate("+x+","+y+")" + scl;
            res.attrs = {x: x, y: y, width: w, height: h, fill: "none", stroke: "#000", transform: trf};
            $(el, res.attrs);
            res.type = "rect";
            var bd = doc.createElement("body");
    ...
    Paper[proto].frame = function (x, y, w, h, u, s) {
        return theFrame(this, x || 0, y || 0, w || 0, h || 0, u || 0, s || null);
    };
