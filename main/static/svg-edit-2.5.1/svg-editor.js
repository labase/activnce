	...
	if(!window.svgEditor) window.svgEditor = function($) {
		...
		var defaultPrefs = {
			...
			curConfig = {
				...
				initOpacity: 1,
				imgPath: '/static/svg-edit-2.5.1/images/',
				langPath: '/static/svg-edit-2.5.1/locale/',
				extPath: '/static/svg-edit-2.5.1/extensions/',
		...
		Editor.init = function() {
			...
			var saveHandler = function(window,svg) {
				...
				var codDesenho = "data:image/svg+xml;base64," + Utils.encode64(svg);
				salvaDesenho(codDesenho);
				return;
