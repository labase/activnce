...
_INICIO_DOS_TEMPOS = "2011-01-01 00:00:00.000000"
...
def main():
    ...
    for doc_id in WIKI:
        ...
        if not wiki_data["data_cri"]:
            wiki_data["data_cri"] = _INICIO_DOS_TEMPOS
        if not wiki_data["data_alt"]:
    ...
    for post_id in BLOG:
        ...
        if not blog_data["data_cri"]:
            blog_data["data_cri"] = _INICIO_DOS_TEMPOS
        if not blog_data["data_alt"]:
            blog_data["data_alt"] = blog_data["data_cri"]
